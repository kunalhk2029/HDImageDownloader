 ...
 */
class ScalingImageView : androidx.appcompat.widget.AppCompatImageView,
...
//        Logger.log("897897897  1 =  ${viewWidth==origWidth.toInt()}")
//        Logger.log("897897897  3 =  ${viewHeight==origHeight.toInt()}")
//
//        Logger.log("897897897  30 =  ${viewHeight} = "+origHeight)
//        Logger.log("897897897  301 =  ${viewWidth} = "+origWidth)
//
        when (event.action) {
